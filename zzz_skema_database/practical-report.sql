...
CREATE DATABASE IF NOT EXISTS `practical-report` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE IF NOT EXISTS `aslab` (
  ...
  `notel` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `motto` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `instagram` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `facebook` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Meyimpan data asisten lab';
...
CREATE TABLE IF NOT EXISTS `dosen` (
  ...
  `facebook` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=501 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Menyimpan dosen yang aktif mengajar mata kuliah praktikum';
...
CREATE TABLE IF NOT EXISTS `laboran` (
  ...
  `facebook` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Menyimpan data laboran';
...
CREATE TABLE IF NOT EXISTS `mahasiswa` (
  `nim` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  `nama` varchar(255) DEFAULT NULL,
  `stambuk` smallint unsigned DEFAULT NULL,
  PRIMARY KEY (`nim`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Menyimpan seluruh mahasiswa yang aktif dalam mata kuliah praktikum';
...
CREATE TABLE IF NOT EXISTS `mata_kuliah` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `semester` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `kelas` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Menyimpan semua mata kuliah praktikum yang sedang aktif';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Tabel penghubung antara Mahasiswa, Status, dan Mata Kuliah';
